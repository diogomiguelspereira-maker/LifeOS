...
const ITEMS: { href: string; icon: typeof Target; label: (t: Dict) => string }[] = [
  ...
  { href: "/app/wishlist", icon: Gift, label: (t) => t.wishlist.title },
  ...
  { href: "/app/driving", icon: Car, label: (t) => t.driving.title },
  { href: "/app/location", icon: MapPin, label: (t) => t.location.title },
